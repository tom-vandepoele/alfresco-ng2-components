...
export class TaskDetailsModel {
    ...
    public adhocTaskCanBeReassigned: number;
    ...
    public initiatorCanCompleteTask: boolean;
    public managerOfCandidateGroup: boolean;
    public memberOfCandidateGroup: boolean;
    public memberOfCandidateUsers: boolean;
    public involvedPeople: User [];
    ...
    public processDefinitionVersion: number = 0;
    public processInstanceId: string;
    public processInstanceName: string;
    public processInstanceStartUserId: string;
